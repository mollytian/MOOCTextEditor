...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */
			BasicDocument basicDoc = new BasicDocument(textfile);
			...
			long basicTime = (System.nanoTime() - basicStartTime);
			 ...
			 *     b. Calls fleshScore on this document
			 */
			EfficientDocument efficientDoc = new EfficientDocument(textfile);
			...
			long efficientTime = (System.nanoTime() - efficientStartTime);
